(function (root, factory) {
  ...
  function sendLoginCode(email, code) {
    const subject = 'Your KROO Login Code';
    const htmlBody = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f8fafc; color: #1e293b; padding: 32px; border-radius: 12px; max-width: 420px; margin: 0 auto;">
        <div style="text-align: center;">
          <img src="https://lh3.googleusercontent.com/d/1JDO6dqyJ8U6hrIuzDk31VibFtIIs5Pd_" alt="KROO Creative Collective" width="80" style="margin-bottom: 16px;" />
          <h2 style="color: #f59e0b; margin-bottom: 8px;">Login Confirmation</h2>
          <p style="font-size: 1.1rem; color: #64748b; margin-bottom: 24px;">Use the code below to log in to your KROO Creative Collective account:</p>
        ...
        <div style="margin-top: 32px; text-align: center; color: #94a3b8; font-size: 0.85rem;">KROO Creative Collective &copy; 2025</div>
      </div>
    `;
    try {
